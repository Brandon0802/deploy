...
const routes = [
    ...
    {
        path: 'newhome',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_productlist_productlist_page_ts"), __webpack_require__.e("default-src_app_product3list_product3list_page_ts"), __webpack_require__.e("default-src_app_product2list_product2list_page_ts"), __webpack_require__.e("common"), __webpack_require__.e("src_app_newhome_newhome_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./newhome/newhome.module */ 97946)).then(m => m.NewhomePageModule)
    },
    {
        path: 'newhome/:id',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_productlist_productlist_page_ts"), __webpack_require__.e("default-src_app_product3list_product3list_page_ts"), __webpack_require__.e("default-src_app_product2list_product2list_page_ts"), __webpack_require__.e("common"), __webpack_require__.e("src_app_newhome_newhome_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./newhome/newhome.module */ 97946)).then(m => m.NewhomePageModule)
    ...
    {
        path: 'admin-panel',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_admin-panel_admin-panel_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./admin-panel/admin-panel.module */ 68369)).then(m => m.AdminPanelPageModule)
    }, {
        path: 'admin-panel/:id',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_admin-panel_admin-panel_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./admin-panel/admin-panel.module */ 68369)).then(m => m.AdminPanelPageModule)
    },
    {
        path: 'product2list',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_product2list_product2list_page_ts"), __webpack_require__.e("src_app_data_service_ts-src_app_product2list_product2list_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./product2list/product2list.module */ 16477)).then(m => m.Product2listPageModule)
    },
    {
        path: 'product3list',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_product3list_product3list_page_ts"), __webpack_require__.e("src_app_data_service_ts-src_app_product3list_product3list_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./product3list/product3list.module */ 26510)).then(m => m.Product3listPageModule)
    },
    {
        path: 'product4list',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_product4list_product4list_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./product4list/product4list.module */ 64017)).then(m => m.Product4listPageModule)
    },
    {
        path: 'accounts',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_accounts_accounts_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./accounts/accounts.module */ 60164)).then(m => m.AccountsPageModule)
    },
    {
        path: 'approve',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_approve_approve_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./approve/approve.module */ 69076)).then(m => m.ApprovePageModule)
    },
    {
        path: 'approve-driver',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_approve-driver_approve-driver_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./approve-driver/approve-driver.module */ 96407)).then(m => m.ApproveDriverPageModule)
    },
    {
        path: 'edit-account',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_edit-account_edit-account_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./edit-account/edit-account.module */ 73569)).then(m => m.EditAccountPageModule)
    },
    {
        path: 'approve-queue',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_approve-queue_approve-queue_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./approve-queue/approve-queue.module */ 35179)).then(m => m.ApproveQueuePageModule)
    },
    {
        path: 'admin-prods',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_admin-prods_admin-prods_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./admin-prods/admin-prods.module */ 56766)).then(m => m.AdminProdsPageModule)
    },
];
    ...
    initializeApp() {
        this.storage.get('storage_xxx').then((res) => {
            if (res == null) {
                ...
                console.log(this.datastorage.admin);
                ...
                else if (this.datastorage.consumer == 'Consumer') {
                    this.consumer = true;
                ...
                else if (this.datastorage.admin == 'Admin') {
                    this.navController.navigateRoot('/panel-admin');
                    this.admin = true;
                }
            }
        });
...
let AccessProviders = class AccessProviders {
    constructor(http) {
        this.http = http;
        this.server = 'http://128.199.73.52/api/';
    }
    postData(body, file) {
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (".menu-header-bg {\n  height: 180px;\n  width: 650px;\n  background: #000000;\n  background: linear-gradient(180deg, #3880ff 0%, white 100%);\n  margin-top: -50px;\n}\n\n.header-content {\n  position: absolute;\n  padding-left: 14%;\n  top: 5px;\n  align-items: center;\n}\n\n.header-content img {\n  height: 250px;\n}\n\n.header-content h2 {\n  font-weight: 300;\n  color: black;\n}\n\n.header-content p {\n  font-size: 12px;\n  color: #000000;\n  font-weight: 100;\n  letter-spacing: 0.4px;\n}\n\n.action-button {\n  display: flex;\n  justify-content: center;\n  margin-bottom: 20px;\n}\n\n.action-button ion-button {\n  text-transform: captilizes;\n  font-weight: 300;\n  --background: #000000;\n  --badckground-radius: 7px;\n  --boc-shadow:none;\n}\n\n.action-button ion-icon {\n  margin-right: 1px;\n}\n\n.menu-items {\n  margin: 0px;\n}\n\n.menu-items ion-icon {\n  margin-right: 20px;\n  color: #000000;\n}\n\n.menu-items ion-item {\n  padding-left: 20px;\n  margin-bottom: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
